...
public class TwitchClient {
    private static final String TOKEN = "Bearer xvditbt3xn99gb3t8h8d7greqzlrmq";
    private static final String CLIENT_ID = "73989c0niisdd7yi4nigzvubxqwqh3";
    ...
    private String buildGameURL(String url_template,String gameName,int limit){
        if(gameName.equals("")){
            ...
            return String.format(url_template, gameName);
    ...
    private String searchTwitch(String url) throws TwitchException{
        ...
        ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
            ...
            public String handleResponse(
                ...
                //data is what we want from response
        ...
        public List<Game> topGames(int limit) throws TwitchException {
            ...
            String searchResponse = searchTwitch(url);
            List<Game> res = getGameList(searchResponse);
